...
const Contact = () => {
  ...
  return (
    <section id="contact" className="contact section" style={{ position: 'relative', padding: '3rem 0', overflow: 'hidden', minHeight: '100vh' }}>
      ...
      {/* Custom CSS for black placeholders */}
      <style jsx>{`
        ...
        .branch-selector:hover {
          background-color: rgba(214, 202, 20, 0.2) !important;
        }
        .branch-selector.active {
          background-color: rgba(214, 202, 20, 0.3) !important;
          border-left: 4px solid #d6ca14 !important;
        }
      `}</style>
      ...
      <div className="container section-title" style={{ position: 'relative', zIndex: 1, paddingTop: '2rem' }}>
        ...
        <div style={{ color: '#fff' }}>
          Get In <span style={{ color: '#d6ca14' }}>Touch</span>
        </div>
      </div>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1, paddingBottom: '3rem' }}>
        <div className="row gy-5 gx-lg-5">
          {/* Contact Info - KEEP ORIGINAL, NO BRANCHES HERE */}
          <div className="col-lg-4">
            <div className="info" style={{
              ...
              <div className="info-item d-flex">
                <i className="bi bi-geo-alt flex-shrink-0" style={{ color: '#d6ca14', fontSize: '1.5rem' }}></i>
              ...
              <div className="info-item d-flex mt-4">
                <i className="bi bi-envelope flex-shrink-0" style={{ color: '#d6ca14', fontSize: '1.5rem' }}></i>
                <div style={{ marginLeft: '15px' }}>
              ...
              <div className="info-item d-flex mt-4">
                <i className="bi bi-phone flex-shrink-0" style={{ color: '#d6ca14', fontSize: '1.5rem' }}></i>
                <div style={{ marginLeft: '15px' }}>
          ...
          <div className="col-lg-8">
            <form onSubmit={handleSubmit} className="php-email-form" style={{
              ...
              <div className="row">
                <div className="col-md-6 form-group">
                  <input 
                    type="text" 
                    name="name" 
                    className="form-control black-placeholder" 
              ...
              {/* Messages */}
              <div className="my-3">
                {loading && <div style={{ color: '#d6ca14', textAlign: 'center' }}>Sending your message...</div>}
        ...
        <div style={{ 
          ...
          {mapLoading ? (
            <div style={{ 
              ...
              <div style={{ color: '#d6ca14', fontSize: '1.2rem' }}>
                Loading branches...
              </div>
            </div>
          ) : (
                  ...
                  <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
                    {branches.map((branch) => (
                      <div 
                        ...
                        style={{ 
                          borderLeft: '3px solid #d6ca14', 
                          backgroundColor: selectedBranch?.id === branch.id ? 'rgba(214, 202, 20, 0.3)' : 'rgba(214, 202, 20, 0.1)',
                          borderRadius: '4px'
                        }}
